...
export function CtaSection() {
  return (
    <section className="lg:px-0 relative top-16 z-1">
      <div className="relative mx-auto max-w-81.75 md:max-w-277.75 overflow-hidden rounded-[15px] bg-designo-peach md:max-xl:h-87.5 flex justify-center items-center xl:h-73">
        <Image
        ...
        <div className="relative z-10 grid gap-10 text-center xl:min-w-230 xl:h-full md:min-h-0 xl:grid-cols-[1fr_auto] md:max-xl:justify-center lg:items-center xl:gap-24 md:max-xl:gap-8 lg:py-0 lg:text-left min-h-94.75 px-6 md:px-0">
