...
export function HomeHero() {
  return (
    <section className="relative isolate px-6 pt-6 sm:px-10 sm:pt-0.75 md:px-0 max-w-277.75 mx-auto">
      <Image
      ...
      <div className="relative z-10 overflow-hidden rounded-[15px] bg-designo-peach md:max-xl:h-210.75 xl:h-160 lg:max-xl:py-15">
        <Image
        ...
        <div className="relative grid md:max-xl:min-h-[843px] items-start gap-20 px-6 pt-20 text-center sm:px-14 sm:pt-16 md:max-xl:h-full md:max-xl:min-h-0 md:max-xl:grid-rows-[auto_1fr] md:max-xl:justify-items-center md:max-xl:gap-0 lg:h-full xl:grid-cols-[540px_1fr] lg:items-center xl:px-24 lg:pt-0 lg:text-left">
          <div className="z-15 flex flex-col md:max-xl:justify-center items-center gap-10 lg:items-start md:max-xl:gap-4.75">
          ...
          <Image
            ...
            className="relative z-10 h-auto xl:w-[39rem] xl:-right-[5rem] md:max-xl:w-160 md:max-lg:row-start-2 md:max-lg:self-end lg:absolute md:bottom-25 lg:max-xl:-bottom-75 xl:-bottom-[15rem] bottom-0"
          />
        </div>
      </div>
    </section>
